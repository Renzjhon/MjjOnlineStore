    ...
    <div class="col-lg-12">    <!--col-lg-12 start-->
        <ol class="breadcrumb">    <!--breadcrumb start-->
            <li class="active">    <!--li start-->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Weekly Inventory Report
        ...
        <div class="panel panel-defaults">    <!--pane panel-defaults start-->
            <div class="panel-heading">    <!--panel-heading start-->
                <h3 class="panel-title">    <!--panel-title start-->
                    ...
                    <i class="fa fa-tags"></i> View Weekly Inventory Report
                    
                </h3>    <!--panel-title end-->
            </div>    <!--panel-heading end-->
            
            <h1><center>Pick A Week</center></h1>
            <button id="weekly_inventory" style="font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 5px; background-color: 	#32cd32; padding: 15px 30px; border: 1px solid #ADD8E6; display: block;">Download</button>
            <form action="" class="form-horizontal" method="post"> 
             <center><input type='week' id='' name="week" placeholder="Select Week" max="<?php echo $week?>" /></center><br>
...
Ave, Novaliches, Quezon City
            ...
            <div style="width: 18%; float:right">
              ...
              <center>
                  <h2 style="font-size:50px; color:white">Weekly Inventory Report <br></h2>
                ...
                <br>
                 <center><h3>For <strong><?php echo $display_date;?> - <?php echo $display_date_last;?></strong></h3></center>
              <br>
               <div class="row">
       ...
       <?php 
                                ...
                                while($row_pro=mysqli_fetch_array($run_pro)){
                                    ...
                                    $edit_inventory = "select * from inventory_report where product_id='$pro_id' and date = '$d7' order by report_id desc";
...
<script>
    ...
    document.getElementById("weekly_inventory")
    .addEventListener("click",()=>{
        ...
        console.log(window); 
        var opt= {
            filename:       'Weekly_Inventory_Report.pdf',
