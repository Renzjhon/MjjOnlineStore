    ...
    <div class="col-lg-12">    <!--col-lg-12 start-->
        <ol class="breadcrumb">    <!--breadcrumb start-->
            <li class="active">    <!--li start-->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Critical Inventory Report
        ...
        <div class="panel panel-defaults">    <!--pane panel-defaults start-->
            <div class="panel-heading">    <!--panel-heading start-->
                <h3 class="panel-title">    <!--panel-title start-->
                    ...
                    <i class="fa fa-tags"></i> Dashboard / View Critical Inventory Report
                    
                </h3>    <!--panel-title end-->
            </div>    <!--panel-heading end-->
            
            
            <button id="critical_inventory" style="font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 5px; background-color: 	#32cd32; padding: 15px 30px; border: 1px solid #ADD8E6; display: block;">Download</button>
...
Ave, Novaliches, Quezon City
            ...
            <div style="width: 18%; float:right">
              ...
              <center>
                  <h2 style="font-size:50px; color:white">Critical Inventory Report <br></h2>
                    ...
                    <table class="table table-striped table-bordered table-hover table-striped table-earning" style="color:black;">    <!--table table-striped table-bordered table-hover start-->
                        ...
                        <?php 
                                ...
                                while($row_pro=mysqli_fetch_array($run_pro)){
                                    ...
                                    $edit_inventory = "select * from inventory";
                                    ...
                                    $row_edit = mysqli_fetch_array($run_edit);
                                        ...
                                        $stock = $row_edit['qty_stock'];
                                    
                                        $critical_level = $row_edit['critical_level'];
                        ...
                        <tbody style="color:black;">    <!--tbody start-->
                            ...
                            <tr style="color:black;">    <!--tr start-->
                                ...
                                <td style="color:black;">  <?php echo $critical_level; ?> </td>
...
<script>
    ...
    document.getElementById("critical_inventory")
    .addEventListener("click",()=>{
        ...
        console.log(window); 
        var opt= {
            filename:       'Critical_Inventory_Report.pdf',
