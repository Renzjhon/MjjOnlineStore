    ...
    <div class="col-lg-12">    <!--col-lg-12 start-->
        <ol class="breadcrumb">    <!--breadcrumb start-->
            <li class="active">    <!--li start-->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Yearly Inventory Report
        ...
        <div class="panel panel-defaults">    <!--pane panel-defaults start-->
            <div class="panel-heading">    <!--panel-heading start-->
                <h3 class="panel-title">    <!--panel-title start-->
                    ...
                    <i class="fa fa-tags"></i> View Yearly Inventory Report
            ...
            <button id="yearly_inventory" style="font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 5px; background-color: 	#32cd32; padding: 15px 30px; border: 1px solid #ADD8E6; display: block;">Download</button>
            ...
            <form action="" class="form-horizontal" method="post"> 
             <center>
                                ...
                                </select>    <!--form-control end--></center><br>
...
Ave, Novaliches, Quezon City
            ...
            <div style="width: 18%; float:right">
              ...
              <center>
                  <h2 style="font-size:50px; color:white">Yearly Inventory Report <br></h2>
...
<script>
    ...
    document.getElementById("yearly_inventory")
    .addEventListener("click",()=>{
        ...
        console.log(window); 
        var opt= {
            filename:       'Yearly_Inventory_Report.pdf',
