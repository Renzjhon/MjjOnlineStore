    ...
    <div class="col-lg-12">    <!--col-lg-12 start-->
        <ol class="breadcrumb">    <!--breadcrumb start-->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Services Materials
        ...
        <div class="panel panel-default">    <!--panel panel-default start-->  
            <div class="panel-heading">    <!--panel-heading start-->
                <h3 class="panel-title">    <!--panel-title start-->
                    ...
                    <i class="fa fa-tags fa-fw"></i> View Services Materials
                
                </h3>    <!--panel-title end-->
            </div>    <!--panel-heading end--> <br>
             <center><input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for materials.." title="Type in a name"></center>
                    ...
                    <table class="table table-hover table-striped table-bordered" id="myTable">    <!--table table-hover table-striped table-bordered start-->
                        ...
                        <tbody>    <!--tbody start-->
                            ...
                            <tr>    <!--tr start-->
                                ...
                                <td> 
                                    <?php 
                                    $get_materials = "select * from services_materials where service_id = '$service_id'";
                            
                                    $run_materials = mysqli_query($con,$get_materials);
        
                                    while($row_materials=mysqli_fetch_array($run_materials)){
                                    
                                    $materials = $row_materials['material'];
                                        echo "$materials, ";
