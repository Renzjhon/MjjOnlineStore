    ...
    <div class="col-lg-12">    <!--col-lg-12 start-->
        ...
        error_reporting(E_ALL ^ E_WARNING); 
            ...
            <form action="" class="form-horizontal" method="post"> 
             <center><input type='date' id='' name="date" placeholder="Select Date" /></center><br>
            ...
            <div class="panel-body" id="pdf">    <!--panel-body start-->
                <div class="table-responsive">    <!--table-responsive start-->
                    <table class="table table-striped table-bordered table-hover" >    <!--table table-striped table-bordered table-hover start-->
                        <div style="display:block;text-align:left"><img align="left" src="icons/logo.png" border="0" width="100px" height="100px"><center><h2>Daily Rider Report <br> Date: <strong><?php echo $display_date;?></strong></h2></center></div>
                        <thead>    <!--thead start-->
                            <tr>    <!--tr start-->
                                <th> Rider Name </th>
                                <th> Rider Email: </th>
...
<!--                                <th> Product Delete: </th>-->
                        ...
                        <tbody>    <!--tbody start-->
                                ...
                                $r_contact = $row_riders['rider_contact'];
                                    $i = 0;
                                $get_orders = "select * from order_summary where rider_id='$r_id' and delivery_date ='$search_date'";
