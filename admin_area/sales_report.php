        ...
        <div class="panel panel-default">    <!--panel panel-default start-->  
            <div class="panel-heading">    <!--panel-heading start-->
                <h3 class="panel-title">    <!--panel-title start-->
                    ...
                    <i class="fa fa-tags fa-fw"></i> View Sales
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?daily_sales_report" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?weekly_sales_report" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?monthly_sales_report" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?yearly_sales_report" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?range_sales_report" >
