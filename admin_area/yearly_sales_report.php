    ...
    <div class="col-lg-12">    <!--col-lg-12 start-->
        <ol class="breadcrumb">    <!--breadcrumb start-->
            <li class="active">    <!--li start-->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Annual Sales
        ...
        <div class="panel panel-defaults">    <!--pane panel-defaults start-->
            <div class="panel-heading">    <!--panel-heading start-->
                <h3 class="panel-title">    <!--panel-title start-->
                    ...
                    <i class="fa fa-tags"></i> View Annual Sales
                    
                </h3>    <!--panel-title end-->
            </div>    <!--panel-heading end-->
            
            <h1><center>Pick A Month</center></h1>
            <button id="yearly_sales" style="font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 5px; background-color: 	#32cd32; padding: 15px 30px; border: 1px solid #ADD8E6; display: block;">Download</button>
...
Ave, Novaliches, Quezon City
            ...
            <div style="width: 18%; float:right">
              ...
              <center>
                  <h2 style="font-size:50px; color:white">Yearly Sales Report <br></h2>
                ...
                <br>
                 <center><h3>For <strong><?php echo $search_date;?></strong></h3></center>
              <br>
               <div class="row">
                        ...
                        <div class="row m-t-25">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                ...
                                $get_payments = "select * from payments where DATE_FORMAT(payment_date, '%Y') = '$search_date'";
                            ...
                            <div class="col-sm-6 col-lg-3">
                                ...
                                $get_payments = "select * from customer_orders where DATE_FORMAT(order_date, '%Y') = '$search_date'";
                        ...
                        <div class="row">
                            ...
                            $get_paymentsa = "select * from payments where order_type = 'product' and DATE_FORMAT(payment_date, '%Y') = '$search_date'";
...
<script>
    ...
    document.getElementById("yearly_sales")
