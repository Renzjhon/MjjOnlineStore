    ...
    <div class="col-lg-12">    <!--col-lg-12 start-->
        <ol class="breadcrumb">    <!--breadcrumb start-->
            <li class="active">    <!--li start-->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Monthly Item Reduced
        ...
        <div class="panel panel-defaults">    <!--pane panel-defaults start-->
            <div class="panel-heading">    <!--panel-heading start-->
                <h3 class="panel-title">    <!--panel-title start-->
                    ...
                    <i class="fa fa-tags"></i> View Monthly Item Reduced
            ...
            <form action="" class="form-horizontal" method="post"> 
             <center><input type='month' id='' name="month" placeholder="Select Month"  max="<?php echo $search_date?>"/></center><br>
                        ...
                        <tbody>    <!--tbody start-->
                            ...
                            <?php 
                                ...
                                while($row_pro=mysqli_fetch_array($run_pro)){
                                    ...
                                    $count1 = $count * $qty;
                                    $get_date = "select * from customer_orders where DATE_FORMAT(order_date, '%Y-%m') = '$search_date'";
