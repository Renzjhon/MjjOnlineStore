    ...
    <div class="col-lg-12">    <!--col-lg-12 start-->
        <ol class="breadcrumb">    <!--breadcrumb start-->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Item Reduced Reports
        ...
        <div class="panel panel-default">    <!--panel panel-default start-->  
            <div class="panel-heading">    <!--panel-heading start-->
                <h3 class="panel-title">    <!--panel-title start-->
                    ...
                    <i class="fa fa-tags fa-fw"></i> View Item Reduced Reports
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?daily_item_reduced_report" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?weekly_item_reduced_report" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?monthly_item_reduced_report" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?yearly_item_reduced_report" >
