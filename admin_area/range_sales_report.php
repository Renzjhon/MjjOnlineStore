    ...
    <div class="col-lg-12">    <!--col-lg-12 start-->
        <ol class="breadcrumb">    <!--breadcrumb start-->
            <li class="active">    <!--li start-->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Range Sales Report
        ...
        <div class="panel panel-defaults">    <!--pane panel-defaults start-->
            <div class="panel-heading">    <!--panel-heading start-->
                <h3 class="panel-title">    <!--panel-title start-->
                    ...
                    <i class="fa fa-tags"></i> View Range Sales Report
                    
                </h3>    <!--panel-title end-->
            </div>    <!--panel-heading end-->
            
            <h1><center>Pick A Range Date</center></h1>
            <button id="range_sales" style="font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 5px; background-color: 	#32cd32; padding: 15px 30px; border: 1px solid #ADD8E6; display: block;">Download</button>
            
            <form action="" class="form-horizontal" method="post"> 
             <center><strong style=" font-size: 20px;">From: </strong><input type='date' id='' name="date_min" placeholder="Select Date" max="<?php echo $date_today?>" /></center><br>
            <center><strong style=" font-size: 20px;">To: </strong><input type='date' id='' name="date_max" placeholder="Select Date"  /></center><br>
...
Ave, Novaliches, Quezon City
            ...
            <div style="width: 18%; float:right">
              ...
              <center>
                  <h2 style="font-size:50px; color:white">Range Sales Report <br></h2>
                ...
                <br>
                 <center><h3>For <strong><?php echo $display_date_min;?> - <?php echo $display_date_max;?></strong></h3></center>
              <br>
               <div class="row">
                        ...
                        <div class="row m-t-25">
                            ...
                            <div class="col-sm-6 col-lg-3">
                                ...
                                $get_payments = "select * from payments where payment_date between '$search_date_min' and '$search_date_max'";
                            ...
                            <div class="col-sm-6 col-lg-3">
                                ...
                                $get_payments = "select * from customer_orders where order_date between '$search_date_min' and '$search_date_max';";
                        ...
                        <div class="row">
                            ...
                            $get_paymentsa = "select * from payments where order_type = 'product' and payment_date between '$search_date_min' and '$search_date_max';";
...
<script>
    ...
    document.getElementById("range_sales")
    .addEventListener("click",()=>{
        ...
        console.log(window); 
        var opt= {
            filename:       'Range_Sales_Report.pdf',
