        ...
        <div class="panel panel-default">    <!--panel panel-default start-->  
            <div class="panel-heading">    <!--panel-heading start-->
                <h3 class="panel-title">    <!--panel-title start-->
                    ...
                    <i class="fa fa-tags fa-fw"></i> View Order Reports
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?daily_order_reports" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?weekly_order_reports" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?monthly_order_reports" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?yearly_order_reports" >
                    ...
                    <div class="panel panel-primary">    <!--panel panel-primary start-->
                        ...
                        <div class="panel-footer">    <!--panel-footer start-->
                            <center>    <!--center start-->
                                ...
                                <a href="index.php?range_order_report" >
